...
const TicketsPorStatus = ({ dictionary }: { dictionary: Awaited<ReturnType<typeof getDictionary>> }) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                setData(response.ticketsPorStatus || [])
            } catch (error) {
    ...
    const colors = data.map(item => statusColors[item.status] || 'var(--mui-palette-primary-main)')
    ...
    return (
        <Card className='bs-full'>
            <CardHeader title='Tickets por Status' />
            <CardContent>
...
export default TicketsPorStatus
