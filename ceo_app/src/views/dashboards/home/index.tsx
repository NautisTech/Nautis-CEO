            ...
            <Grid container spacing={3}>
              {conteudosData && (
                <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                  <a href='/apps/conteudos/dashboard' className='no-underline'>
                    <Card className='cursor-pointer hover:shadow-lg transition-shadow'>
                      <CardContent className='flex items-center gap-3'>
                        <CustomAvatar color='primary' size={40}>
              ...
              {adminData && (
                <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                  <a href='/apps/admin/dashboard' className='no-underline'>
                    <Card className='cursor-pointer hover:shadow-lg transition-shadow'>
                      <CardContent className='flex items-center gap-3'>
                        <CustomAvatar color='success' size={40}>
              ...
              <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                <a href='/apps/user/list' className='no-underline'>
                  <Card className='cursor-pointer hover:shadow-lg transition-shadow'>
                    <CardContent className='flex items-center gap-3'>
                      <CustomAvatar color='info' size={40}>
              ...
              <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                <a href='/apps/permissions' className='no-underline'>
                  <Card className='cursor-pointer hover:shadow-lg transition-shadow'>
                    <CardContent className='flex items-center gap-3'>
                      <CustomAvatar color='warning' size={40}>
