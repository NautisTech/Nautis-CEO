...
const EquipamentosStatisticsCard = ({ dictionary }: { dictionary: Awaited<ReturnType<typeof getDictionary>> }) => {
    ...
    const slides = [
        {
            ...
            details: {
                'Total': String(stats?.total_equipamentos || 0),
                'Operacionais': String(stats?.equipamentos_operacionais || 0),
                'Manutenção': String(stats?.equipamentos_manutencao || 0),
                'Inativos': String(stats?.equipamentos_inativos || 0)
            }
        },
        {
            title: 'Estado & Garantias',
            img: '/images/cards/graphic-illustration-2.png',
            details: {
                'Avariados': String(stats?.equipamentos_avariados || 0),
                'Em Garantia': String(stats?.equipamentos_em_garantia || 0),
                'Manutenção 30d': String(stats?.manutencoes_proximos_30_dias || 0),
                'Ativos': String(stats?.equipamentos_ativos || 0)
            }
        }
    ]
...
export default EquipamentosStatisticsCard
