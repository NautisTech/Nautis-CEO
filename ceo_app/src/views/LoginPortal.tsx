...
const LoginPortal = ({ mode, dictionary }: { mode: SystemMode; dictionary: Awaited<ReturnType<typeof getDictionary>> }) => {
  // States
  ...
  const onSubmit: SubmitHandler<FormData> = async (data: FormData) => {
    ...
    try {
      ...
      if (result?.error) {
        ...
        setTimeout(() => {
          router.push(getLocalizedUrl('/apps/portal/dashboard', locale as Locale))
            ...
            <Controller
              ...
              render={({ field }) => (
                <CustomTextField
                  ...
                  autoFocus
                  fullWidth
                  label={dictionary['login']?.portalCode}
